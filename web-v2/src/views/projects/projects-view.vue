...
const columns = defineTableColumns([
  { key: "name", name: "项目", minWidth: 180, sortable: true },
  { key: "slug", name: "Slug", minWidth: 140 },
  { key: "status", name: "状态", width: 110, minWidth: 90 },
  { key: "tags", name: "标签", minWidth: 140 },
  { key: "updated_at", name: "更新时间", minWidth: 180, sortable: true },
  { key: "action", name: "操作", width: 220, minWidth: 180 },
]);

function openCreate() {
  editing.value = null;
  Object.assign(form, { name: "", slug: "", description: "", tags: "" });
  ...
  <div class="page">
    ...
    >
      ...
      <template #column:status="{ rowData }">
        <u-tag :type="(rowData as ProductProject).status === 'archived' ? 'warning' : 'success'">
