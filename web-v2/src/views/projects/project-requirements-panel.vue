...
const columns = defineTableColumns([
  ...
  { key: "title", name: "标题", minWidth: 220, sortable: true },
  { key: "status", name: "状态", width: 110, minWidth: 90 },
  { key: "priority", name: "优先级", width: 110, minWidth: 90, sortable: true },
  { key: "assignee_id", name: "负责人", width: 110, minWidth: 90 },
  { key: "updated_at", name: "更新时间", minWidth: 170, sortable: true },
  { key: "action", name: "操作", width: 180, minWidth: 140 },
]);
...
function openEdit(requirement: Requirement) {
  ...
  Object.assign(form, {
    ...
    assignee_id: requirement.assignee_id ?? undefined,
