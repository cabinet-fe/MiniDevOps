...
func (r *WebhookDeliveryRepository) TryInsert(repositoryID uint, deliveryKey string) (bool, error) {
	row := &WebhookDelivery{RepositoryID: repositoryID, DeliveryKey: deliveryKey}
