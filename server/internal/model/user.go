...
type User struct {
	...
	// GiteeToken holds the value of the "gitee_token" field.
	GiteeToken string `json:"-"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUsername, user.FieldPassword, user.FieldGiteeToken:
...
func (u *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldGiteeToken:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field gitee_token", values[i])
			} else if value.Valid {
				u.GiteeToken = value.String
			}
...
func (u *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("gitee_token=<sensitive>")
	builder.WriteString(", ")
