...
func (uc *UserCreate) SetGiteeToken(s string) *UserCreate {
	uc.mutation.SetGiteeToken(s)
	return uc
}

// SetNillableGiteeToken sets the "gitee_token" field if the given value is not nil.
func (uc *UserCreate) SetNillableGiteeToken(s *string) *UserCreate {
	if s != nil {
		uc.SetGiteeToken(*s)
	}
	return uc
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.Username(); !ok {
		return &ValidationError{Name: "username", err: errors.New(`model: missing required field "User.username"`)}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.GiteeToken(); ok {
		_spec.SetField(user.FieldGiteeToken, field.TypeString, value)
		_node.GiteeToken = value
	}
