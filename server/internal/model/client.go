...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.BuildTask.Intercept(interceptors...)
...
// QueryProject queries the project edge of a BuildTask.
func (c *BuildTaskClient) QueryProject(bt *BuildTask) *ProjectQuery {
...
func (c *BuildTaskClient) mutate(ctx context.Context, m *BuildTaskMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("model: unknown BuildTask mutation op: %q", m.Op())
	}
}
...
// QueryBuilds queries the builds edge of a Project.
func (c *ProjectClient) QueryBuilds(pr *Project) *BuildTaskQuery {
...
type (
	hooks struct {
		BuildTask, Project, User []ent.Hook
	}
	inters struct {
		BuildTask, Project, User []ent.Interceptor
	}
)
